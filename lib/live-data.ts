...
const COLUMNS =
  "id, visitor_id, session_id, type, source, occurred_at, url, path, title, referrer, utm_source, utm_medium, utm_campaign, gclid, fbclid, ttclid, msclkid, country, region, city, device";
